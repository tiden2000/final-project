...
<div class="listing-introduction">
    <div class="row">
        <div class="col">
            <div class="image">
                <img src="img/apartment_listing.jpg" alt="" >
                <div class="overlay">
                    <div class="text">Apartments</div>
                </div>
            </div>
        </div>
        <div class="col">
    ...
    <div class="row">
        <div class="product-hold">
            ...
            if(!empty($_POST['search_sql'])) {
              ...
              $sql = "SELECT * FROM products WHERE type='Apartment' ORDER BY `id` DESC LIMIT $offset, $no_of_records_per_page";  // SQL statement for forming pages
            }
