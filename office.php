...
<div class="listing-introduction">
    <div class="row">
        <div class="col">
            <div class="image">
                <img src="img/office_listing.jpg" alt="" >
                <div class="overlay">
    ...
    <div class="row">
        <div class="product-hold">
            ...
            if(!empty($_POST['search_sql'])) {
              ...
              $sql = "SELECT * FROM products WHERE type='Office' ORDER BY `id` DESC LIMIT $offset, $no_of_records_per_page";  // SQL statement for forming pages
            }
